...
def main() -> None:
    ...
    ml_shadow_scorer_online_shadow_policy_parser = subparsers.add_parser(
        "ml-shadow-scorer-online-shadow-policy",
        help="Draft the ml-shadow-scorer-v1 online shadow execution policy without enabling runtime shadowing",
    )
    ml_shadow_scorer_online_shadow_policy_parser.add_argument(
    ...
    ml_shadow_scorer_online_shadow_policy_parser.add_argument(
        "--output",
        required=True,
        help="Path to write ml-shadow-scorer-v1 online shadow policy JSON",
    )
    ml_shadow_scorer_online_shadow_policy_parser.add_argument(
        "--markdown-output",
        required=True,
    ...
    ml_shadow_scorer_online_shadow_policy_parser.add_argument(
        "--policy-version",
        default="ml-shadow-scorer-v1-online-shadow-policy",
        help="Policy version string to write (default: ml-shadow-scorer-v1-online-shadow-policy)",
    )
    ml_shadow_scorer_online_shadow_policy_parser.add_argument(
        "--repo-root",
        default=None,
    ...
    ml_shadow_scorer_runtime_isolation_verification_parser = subparsers.add_parser(
        "ml-shadow-scorer-runtime-isolation-verification",
        help="Verify ml-shadow-scorer-v1 runtime isolation with in-memory probes",
    )
    ml_shadow_scorer_runtime_isolation_verification_parser.add_argument(
    ...
    ml_shadow_scorer_runtime_isolation_verification_parser.add_argument(
        "--output",
        required=True,
        help="Path to write runtime isolation verification JSON",
    )
    ml_shadow_scorer_runtime_isolation_verification_parser.add_argument(
        "--markdown-output",
        required=True,
    ...
    ml_shadow_scorer_runtime_isolation_verification_parser.add_argument(
        ...
        default="ml-shadow-scorer-v1-runtime-isolation-verification-v1",
        help="Verification version string to write (default: ml-shadow-scorer-v1-runtime-isolation-verification-v1)",
    )
    ml_shadow_scorer_runtime_isolation_verification_parser.add_argument(
        "--repo-root",
        default=None,
    ...
    ml_shadow_scorer_online_shadow_enablement_gates_parser = subparsers.add_parser(
        "ml-shadow-scorer-online-shadow-enablement-gates",
        help="Define future ml-shadow-scorer-v1 online shadow enablement gates without executing them",
    )
    ml_shadow_scorer_online_shadow_enablement_gates_parser.add_argument(
    ...
    ml_shadow_scorer_online_shadow_enablement_gates_parser.add_argument(
        "--output",
        required=True,
        help="Path to write online shadow enablement gates definition JSON",
    )
    ml_shadow_scorer_online_shadow_enablement_gates_parser.add_argument(
        "--markdown-output",
        required=True,
    ...
    ml_shadow_scorer_online_shadow_enablement_gates_parser.add_argument(
        "--gates-version",
        default="ml-shadow-scorer-v1-online-shadow-enablement-gates-v1",
        help="Gates version string to write (default: ml-shadow-scorer-v1-online-shadow-enablement-gates-v1)",
    )
    ml_shadow_scorer_online_shadow_enablement_gates_parser.add_argument(
        "--repo-root",
        default=None,
    ...
    ml_shadow_scorer_online_shadow_execution_authorization_request_parser = subparsers.add_parser(
        "ml-shadow-scorer-online-shadow-execution-authorization-request",
        help="Record a request for future ml-shadow-scorer-v1 online shadow execution authorization",
    )
    ml_shadow_scorer_online_shadow_execution_authorization_request_parser.add_argument(
        "--enablement-gates-run",
        required=True,
        help="Path to ml-shadow-scorer-v1-online-shadow-enablement-gates-run-v1 JSON",
    )
    ml_shadow_scorer_online_shadow_execution_authorization_request_parser.add_argument(
        "--output",
        required=True,
        help="Path to write online shadow execution authorization request JSON",
    )
    ml_shadow_scorer_online_shadow_execution_authorization_request_parser.add_argument(
        "--markdown-output",
        required=True,
    ...
    ml_shadow_scorer_online_shadow_execution_authorization_request_parser.add_argument(
        "--request-version",
        default="ml-shadow-scorer-v1-online-shadow-execution-authorization-request-v1",
        help="Request version string to write (default: ml-shadow-scorer-v1-online-shadow-execution-authorization-request-v1)",
    )
    ml_shadow_scorer_online_shadow_execution_authorization_request_parser.add_argument(
        "--repo-root",
        default=None,
    ...
    ml_shadow_scorer_online_shadow_phase1_no_write_pilot_review_parser = subparsers.add_parser(
        "ml-shadow-scorer-online-shadow-phase1-no-write-pilot-review",
        help="Review the ml-shadow-scorer-v1 online shadow Phase 1 no-write pilot result without rerunning it",
    )
    ml_shadow_scorer_online_shadow_phase1_no_write_pilot_review_parser.add_argument(
        "--phase1-no-write-pilot-run",
        required=True,
        help="Path to ml-shadow-scorer-v1-online-shadow-phase1-no-write-pilot-run-v1 JSON",
    )
    ml_shadow_scorer_online_shadow_phase1_no_write_pilot_review_parser.add_argument(
        "--phase1-no-write-pilot-plan",
        required=True,
    ...
    ml_shadow_scorer_online_shadow_phase1_no_write_pilot_review_parser.add_argument(
        "--output",
        required=True,
        help="Path to write online shadow Phase 1 no-write pilot review JSON",
    )
    ml_shadow_scorer_online_shadow_phase1_no_write_pilot_review_parser.add_argument(
        "--markdown-output",
        required=True,
    ...
    ml_shadow_scorer_online_shadow_phase1_no_write_pilot_review_parser.add_argument(
        "--review-version",
        default="ml-shadow-scorer-v1-online-shadow-phase1-no-write-pilot-review-v1",
        help="Review version string to write (default: ml-shadow-scorer-v1-online-shadow-phase1-no-write-pilot-review-v1)",
    )
    ml_shadow_scorer_online_shadow_phase1_no_write_pilot_review_parser.add_argument(
        "--repo-root",
        default=None,
    ...
    ml_shadow_scorer_online_shadow_phase2_isolated_audit_write_mode_proof_parser = subparsers.add_parser(
        "ml-shadow-scorer-online-shadow-phase2-isolated-audit-write-mode-proof",
        help="Run the ml-shadow-scorer-v1 Phase 2 isolated audit write-mode proof and write its gate artifact",
    )
    ml_shadow_scorer_online_shadow_phase2_isolated_audit_write_mode_proof_parser.add_argument(
    ...
    ml_shadow_scorer_online_shadow_phase2_isolated_audit_write_mode_proof_parser.add_argument(
        "--output",
        required=True,
        help="Path to write online shadow Phase 2 isolated audit write-mode proof JSON",
    )
    ml_shadow_scorer_online_shadow_phase2_isolated_audit_write_mode_proof_parser.add_argument(
        "--markdown-output",
        required=True,
    ...
    ml_shadow_scorer_online_shadow_phase2_isolated_audit_write_mode_proof_parser.add_argument(
        "--proof-version",
        default="ml-shadow-scorer-v1-online-shadow-phase2-isolated-audit-write-mode-proof-v1",
        help="Proof version string to write (default: ml-shadow-scorer-v1-online-shadow-phase2-isolated-audit-write-mode-proof-v1)",
    )
    ml_shadow_scorer_online_shadow_phase2_isolated_audit_write_mode_proof_parser.add_argument(
        "--repo-root",
        default=None,
        help="Optional repository root for portable provenance paths and isolated pilot output",
    )
    phase2_proof_cleanup_group = (
        ml_shadow_scorer_online_shadow_phase2_isolated_audit_write_mode_proof_parser.add_mutually_exclusive_group()
    )
    phase2_proof_cleanup_group.add_argument(
        "--cleanup-after-proof",
        dest="cleanup_after_proof",
        action="store_true",
        help="Remove only the resolved pilot_run_id directory after hashing written files (default)",
    )
    phase2_proof_cleanup_group.add_argument(
        "--no-cleanup-after-proof",
        dest="cleanup_after_proof",
        action="store_false",
        help="Leave isolated pilot files on disk for local inspection",
    )
    ml_shadow_scorer_online_shadow_phase2_isolated_audit_write_mode_proof_parser.set_defaults(
        cleanup_after_proof=True
    )
    ml_shadow_scorer_online_shadow_phase2_isolated_audit_write_authorization_request_parser = subparsers.add_parser(
        "ml-shadow-scorer-online-shadow-phase2-isolated-audit-write-authorization-request",
        help="Request owner authorization for a Phase 2 isolated audit write pilot without granting it",
    )
    ml_shadow_scorer_online_shadow_phase2_isolated_audit_write_authorization_request_parser.add_argument(
    ...
    ml_shadow_scorer_online_shadow_phase2_isolated_audit_write_authorization_request_parser.add_argument(
        "--output",
        required=True,
        help="Path to write Phase 2 isolated audit write authorization request JSON",
    )
    ml_shadow_scorer_online_shadow_phase2_isolated_audit_write_authorization_request_parser.add_argument(
        "--markdown-output",
        required=True,
    ...
    ml_shadow_scorer_online_shadow_phase2_isolated_audit_write_authorization_request_parser.add_argument(
        "--request-version",
        default="ml-shadow-scorer-v1-online-shadow-phase2-isolated-audit-write-authorization-request-v1",
        help="Request version string to write (default: ml-shadow-scorer-v1-online-shadow-phase2-isolated-audit-write-authorization-request-v1)",
    )
    ml_shadow_scorer_online_shadow_phase2_isolated_audit_write_authorization_request_parser.add_argument(
        "--repo-root",
        default=None,
    ...
    ml_shadow_scorer_online_shadow_phase2_isolated_audit_write_authorization_grant_parser = subparsers.add_parser(
        "ml-shadow-scorer-online-shadow-phase2-isolated-audit-write-authorization-grant",
        help="Record the bounded Phase 2 isolated audit write-pilot authorization grant without running the pilot",
    )
    ml_shadow_scorer_online_shadow_phase2_isolated_audit_write_authorization_grant_parser.add_argument(
    ...
    ml_shadow_scorer_online_shadow_phase2_isolated_audit_write_authorization_grant_parser.add_argument(
        "--output",
        required=True,
        help="Path to write Phase 2 isolated audit write authorization grant JSON",
    )
    ml_shadow_scorer_online_shadow_phase2_isolated_audit_write_authorization_grant_parser.add_argument(
        "--markdown-output",
        required=True,
    ...
    ml_shadow_scorer_online_shadow_phase2_isolated_audit_write_authorization_grant_parser.add_argument(
        "--grant-version",
        default="ml-shadow-scorer-v1-online-shadow-phase2-isolated-audit-write-authorization-grant-v1",
        help="Grant version string to write (default: ml-shadow-scorer-v1-online-shadow-phase2-isolated-audit-write-authorization-grant-v1)",
    )
    ml_shadow_scorer_online_shadow_phase2_isolated_audit_write_authorization_grant_parser.add_argument(
        "--repo-root",
        default=None,
    ...
    ml_shadow_scorer_production_scoped_shadow_bundle_grant_pilot_parser = subparsers.add_parser(
        "ml-shadow-scorer-production-scoped-shadow-bundle-grant-pilot",
        help="File the production-scoped online shadow pilot authorization grant in the bundle",
    )
    ml_shadow_scorer_production_scoped_shadow_bundle_grant_pilot_parser.add_argument(
        "--bundle",
        required=True,
        help="Path to production-scoped shadow bundle JSON",
    )
    ...
    ml_shadow_scorer_production_scoped_shadow_bundle_grant_pilot_parser.add_argument(
        "--grant-notes",
        default=None,
        help="Optional free-text pilot authorization grant notes recorded verbatim",
    )
    ml_shadow_scorer_production_scoped_shadow_bundle_grant_pilot_parser.add_argument(
        "--expiry-date",
        default="2026-08-27",
        help="Pilot authorization expiry date string (default: 2026-08-27)",
    )
    ml_shadow_scorer_production_scoped_shadow_bundle_grant_pilot_parser.add_argument(
        "--review-by",
        default=None,
    ...
    ml_shadow_scorer_production_scoped_shadow_pilot_harness_run_parser = subparsers.add_parser(
        "ml-shadow-scorer-production-scoped-shadow-pilot-harness-run",
        help="Run the bounded fixture production-scoped online shadow pilot harness",
    )
    ml_shadow_scorer_production_scoped_shadow_pilot_harness_run_parser.add_argument(
        "--bundle",
        required=True,
        help="Path to production-scoped shadow bundle JSON",
    )
    ml_shadow_scorer_production_scoped_shadow_pilot_harness_run_parser.add_argument(
        "--pilot-run-id",
        default=None,
        help="Optional safe pilot harness run id; defaults to ranking_run_id plus UTC timestamp",
    )
    ml_shadow_scorer_production_scoped_shadow_pilot_harness_run_parser.add_argument(
        "--fixture-input",
        default=None,
        help="Optional JSON/JSONL bounded synthetic fixture rows for the pilot harness",
    )
    ml_shadow_scorer_production_scoped_shadow_pilot_harness_run_parser.add_argument(
        "--repo-root",
        default=None,
        help="Optional repository root for resolving bundle references and prod-scoped artifact paths",
    )
    pilot_harness_update_group = (
        ml_shadow_scorer_production_scoped_shadow_pilot_harness_run_parser.add_mutually_exclusive_group()
    )
    pilot_harness_update_group.add_argument(
        "--update-bundle",
        dest="update_bundle",
        action="store_true",
        default=True,
        help="Update the bundle JSON and Markdown after the harness passes (default)",
    )
    pilot_harness_update_group.add_argument(
        "--no-update-bundle",
        dest="update_bundle",
    ...
    ml_shadow_scorer_production_scoped_shadow_live_execution_pilot_review_parser = subparsers.add_parser(
        "ml-shadow-scorer-production-scoped-shadow-live-execution-pilot-review",
        help="Review the recorded bounded live execution production-scoped pilot evidence",
    )
    ml_shadow_scorer_production_scoped_shadow_live_execution_pilot_review_parser.add_argument(
        "--bundle",
        required=True,
        help="Path to production-scoped shadow bundle JSON",
    )
    ...
    ml_shadow_scorer_production_scoped_shadow_live_execution_pilot_review_parser.add_argument(
        "--review-notes",
        default=None,
        help="Optional free-text live execution pilot review notes recorded verbatim",
    )
    ml_shadow_scorer_production_scoped_shadow_live_execution_pilot_review_parser.add_argument(
        "--repo-root",
        default=None,
    ...
    ml_shadow_scorer_production_scoped_shadow_bundle_request_flag_enablement_parser.add_argument(
        "--bundle",
        required=True,
        help="Path to production-scoped shadow bundle JSON",
    )
    ...
    ml_shadow_scorer_production_scoped_shadow_bundle_request_flag_enablement_parser.add_argument(
        "--request-notes",
        default=None,
        help="Optional free-text flag enablement authorization request notes recorded verbatim",
    )
    ml_shadow_scorer_production_scoped_shadow_bundle_request_flag_enablement_parser.add_argument(
        "--repo-root",
        default=None,
    ...
    ml_shadow_scorer_production_scoped_shadow_bundle_request_production_default_api_user_visible_parser = (
        subparsers.add_parser(
            "ml-shadow-scorer-production-scoped-shadow-bundle-request-production-default-api-user-visible",
            help=(
                "File the production-scoped online shadow production default/API/user-visible "
                "authorization request in the bundle"
            ),
        )
    )
    ml_shadow_scorer_production_scoped_shadow_bundle_request_production_default_api_user_visible_parser.add_argument(
        "--bundle",
        required=True,
        help="Path to production-scoped shadow bundle JSON",
    )
    ...
    ml_shadow_scorer_production_scoped_shadow_bundle_request_production_default_api_user_visible_parser.add_argument(
        "--request-notes",
        default=None,
        help="Optional free-text production default/API/user-visible authorization request notes recorded verbatim",
    )
    ml_shadow_scorer_production_scoped_shadow_bundle_request_production_default_api_user_visible_parser.add_argument(
        "--repo-root",
        default=None,
    ...
    ml_shadow_scorer_production_scoped_shadow_bundle_request_controlled_production_recommendation_parser = (
        subparsers.add_parser(
    ...
    ml_shadow_scorer_production_scoped_shadow_bundle_request_controlled_production_recommendation_parser.add_argument(
        "--bundle",
        required=True,
        help="Path to production-scoped shadow bundle JSON",
    )
    ...
    ml_shadow_scorer_production_scoped_shadow_bundle_request_controlled_production_recommendation_parser.add_argument(
        "--request-notes",
        default=None,
        help="Optional free-text controlled production recommendation authorization request notes recorded verbatim",
    )
    ml_shadow_scorer_production_scoped_shadow_bundle_request_controlled_production_recommendation_parser.add_argument(
        "--repo-root",
        default=None,
    ...
    ml_shadow_scorer_production_scoped_shadow_bundle_request_limited_rollout_parser = (
        subparsers.add_parser(
    ...
    ml_shadow_scorer_production_scoped_shadow_bundle_request_limited_rollout_parser.add_argument(
        "--bundle",
        required=True,
        help="Path to production-scoped shadow bundle JSON",
    )
    ...
    ml_shadow_scorer_production_scoped_shadow_bundle_request_limited_rollout_parser.add_argument(
        "--request-notes",
        default=None,
        help="Optional free-text limited production recommendation rollout request notes recorded verbatim",
    )
    ml_shadow_scorer_production_scoped_shadow_bundle_request_limited_rollout_parser.add_argument(
        "--repo-root",
        default=None,
    ...
    ml_shadow_scorer_production_scoped_shadow_bundle_grant_production_default_api_user_visible_parser.add_argument(
        "--bundle",
        required=True,
        help="Path to production-scoped shadow bundle JSON",
    )
    ...
    ml_shadow_scorer_production_scoped_shadow_bundle_grant_production_default_api_user_visible_parser.add_argument(
        "--grant-notes",
        default=None,
        help="Optional free-text production default/API/user-visible authorization grant notes recorded verbatim",
    )
    ml_shadow_scorer_production_scoped_shadow_bundle_grant_production_default_api_user_visible_parser.add_argument(
        "--expiry-date",
        default="2026-08-27",
        help="Production default/API/user-visible authorization expiry date string (default: 2026-08-27)",
    )
    ml_shadow_scorer_production_scoped_shadow_bundle_grant_production_default_api_user_visible_parser.add_argument(
        "--review-by",
        default=None,
    ...
    ml_shadow_scorer_production_scoped_shadow_bundle_grant_flag_enablement_parser = subparsers.add_parser(
        "ml-shadow-scorer-production-scoped-shadow-bundle-grant-flag-enablement",
        help="File the production-scoped online shadow flag enablement authorization grant in the bundle",
    )
    ml_shadow_scorer_production_scoped_shadow_bundle_grant_flag_enablement_parser.add_argument(
        "--bundle",
        required=True,
        help="Path to production-scoped shadow bundle JSON",
    )
    ...
    ml_shadow_scorer_production_scoped_shadow_bundle_grant_flag_enablement_parser.add_argument(
        "--grant-notes",
        default=None,
        help="Optional free-text flag enablement authorization grant notes recorded verbatim",
    )
    ml_shadow_scorer_production_scoped_shadow_bundle_grant_flag_enablement_parser.add_argument(
        "--expiry-date",
        default="2026-08-27",
        help="Flag enablement authorization expiry date string (default: 2026-08-27)",
    )
    ml_shadow_scorer_production_scoped_shadow_bundle_grant_flag_enablement_parser.add_argument(
        "--review-by",
        default=None,
    ...
    ml_shadow_scorer_production_scoped_shadow_bundle_request_live_read_only_parser.add_argument(
        "--bundle",
        required=True,
        help="Path to production-scoped shadow bundle JSON",
    )
    ...
    ml_shadow_scorer_production_scoped_shadow_bundle_request_live_read_only_parser.add_argument(
        "--request-notes",
        default=None,
        help="Optional free-text live read-only authorization request notes recorded verbatim",
    )
    ml_shadow_scorer_production_scoped_shadow_bundle_request_live_read_only_parser.add_argument(
        "--repo-root",
        default=None,
    ...
    ml_shadow_scorer_production_scoped_shadow_bundle_request_live_execution_parser = subparsers.add_parser(
        "ml-shadow-scorer-production-scoped-shadow-bundle-request-live-execution",
        help="File the production-scoped online shadow live execution authorization request in the bundle",
    )
    ml_shadow_scorer_production_scoped_shadow_bundle_request_live_execution_parser.add_argument(
        "--bundle",
        required=True,
        help="Path to production-scoped shadow bundle JSON",
    )
    ...
    ml_shadow_scorer_production_scoped_shadow_bundle_request_live_execution_parser.add_argument(
        "--request-notes",
        default=None,
        help="Optional free-text live execution authorization request notes recorded verbatim",
    )
    ml_shadow_scorer_production_scoped_shadow_bundle_request_live_execution_parser.add_argument(
        "--repo-root",
        default=None,
    ...
    ml_shadow_scorer_production_scoped_shadow_bundle_grant_live_execution_parser = subparsers.add_parser(
        "ml-shadow-scorer-production-scoped-shadow-bundle-grant-live-execution",
        help="File the production-scoped online shadow live execution authorization grant in the bundle",
    )
    ml_shadow_scorer_production_scoped_shadow_bundle_grant_live_execution_parser.add_argument(
        "--bundle",
        required=True,
        help="Path to production-scoped shadow bundle JSON",
    )
    ...
    ml_shadow_scorer_production_scoped_shadow_bundle_grant_live_execution_parser.add_argument(
        "--grant-notes",
        default=None,
        help="Optional free-text live execution authorization grant notes recorded verbatim",
    )
    ml_shadow_scorer_production_scoped_shadow_bundle_grant_live_execution_parser.add_argument(
        "--expiry-date",
        default="2026-08-27",
        help="Live execution authorization expiry date string (default: 2026-08-27)",
    )
    ml_shadow_scorer_production_scoped_shadow_bundle_grant_live_execution_parser.add_argument(
        "--review-by",
        default=None,
    ...
    plan_bundle_verify_group.add_argument(
        ...
        action="store_true",
        help="Require post-pilot-grant production-scoped shadow bundle state",
    )
    plan_bundle_verify_group.add_argument(
    ...
    plan_bundle_verify_group.add_argument(
        ...
        action="store_true",
        help="Require post-live-execution-request production-scoped shadow bundle state",
    )
    plan_bundle_verify_group.add_argument(
        "--expect-live-execution-grant-filed",
        action="store_true",
        help="Require post-live-execution-grant production-scoped shadow bundle state",
    )
    plan_bundle_verify_group.add_argument(
        "--expect-live-execution-pilot-run-filed",
        action="store_true",
        help="Require post-live-execution-pilot-run production-scoped shadow bundle state",
    )
    plan_bundle_verify_group.add_argument(
        "--expect-live-execution-pilot-review-filed",
        action="store_true",
        help="Require post-live-execution-pilot-review production-scoped shadow bundle state",
    )
    plan_bundle_verify_group.add_argument(
        "--expect-flag-enablement-request-filed",
        action="store_true",
        help="Require post-flag-enablement-request production-scoped shadow bundle state",
    )
    plan_bundle_verify_group.add_argument(
        "--expect-flag-enablement-grant-filed",
        action="store_true",
        help="Require post-flag-enablement-grant production-scoped shadow bundle state",
    )
    plan_bundle_verify_group.add_argument(
    ...
    plan_bundle_verify_group.add_argument(
        ...
        action="store_true",
        help="Require post-production-default/API/user-visible-request production-scoped shadow bundle state",
    )
    plan_bundle_verify_group.add_argument(
        "--expect-production-default-api-user-visible-grant-filed",
        action="store_true",
        help="Require post-production-default/API/user-visible-grant production-scoped shadow bundle state",
    )
    plan_bundle_verify_group.add_argument(
    ...
    plan_bundle_verify_group.add_argument(
        ...
        action="store_true",
        help="Require post-controlled-production-recommendation-pilot-review production-scoped shadow bundle state",
    )
    plan_bundle_verify_group.add_argument(
    ...
    for command_name, help_text in (
        (
            ...
            "Run the bounded production-scoped live execution online shadow pilot",
        ),
        (
            "ml-shadow-scorer-production-scoped-shadow-bundle-run-live-execution-pilot",
            "Run the bounded live execution pilot and update the bundle",
        ),
    ):
        live_execution_pilot_parser = subparsers.add_parser(command_name, help=help_text)
        ...
        live_execution_pilot_parser.add_argument(
            ...
            action="store_true",
            required=True,
            help="Required confirmation before the bounded live execution pilot",
        )
        live_execution_pilot_parser.add_argument(
            "--confirm-live-read-only-prod-source-reads",
            action="store_true",
        ...
        live_execution_pilot_parser.add_argument(
            "--pilot-run-id",
            default=None,
            help="Optional safe pilot run id; defaults to prod-live-exec ranking_run_id plus UTC timestamp",
        )
        live_execution_pilot_parser.add_argument(
            "--repo-root",
            default=None,
        ...
        live_execution_pilot_update_group = live_execution_pilot_parser.add_mutually_exclusive_group()
        live_execution_pilot_update_group.add_argument(
            "--update-bundle",
            dest="update_bundle",
            action="store_true",
            default=True,
        ...
        live_execution_pilot_update_group.add_argument(
            ...
            dest="update_bundle",
            action="store_false",
            help="Run the live execution pilot and write local artifacts without updating the bundle",
        )
    for command_name, help_text in (
        (
            "ml-shadow-scorer-production-scoped-shadow-flag-enablement-pilot-run",
            "Run the bounded production-scoped flag enablement online shadow pilot",
        ),
        (
            "ml-shadow-scorer-production-scoped-shadow-bundle-run-flag-enablement-pilot",
            "Run the bounded flag enablement pilot and update the bundle",
        ),
    ):
        flag_enablement_pilot_parser = subparsers.add_parser(command_name, help=help_text)
        flag_enablement_pilot_parser.add_argument(
            "--bundle",
            required=True,
            help="Path to production-scoped shadow bundle JSON",
        )
        flag_enablement_pilot_parser.add_argument(
            ...
            action="store_true",
            required=True,
            help="Required confirmation before the bounded flag enablement pilot",
        )
        flag_enablement_pilot_parser.add_argument(
            "--confirm-live-read-only-prod-source-reads",
            action="store_true",
        ...
        flag_enablement_pilot_parser.add_argument(
            "--pilot-run-id",
            default=None,
            help="Optional safe pilot run id; defaults to prod-flag-enable ranking_run_id plus UTC timestamp",
        )
        flag_enablement_pilot_parser.add_argument(
            "--repo-root",
            default=None,
        ...
        flag_enablement_pilot_update_group = flag_enablement_pilot_parser.add_mutually_exclusive_group()
        flag_enablement_pilot_update_group.add_argument(
            "--update-bundle",
            dest="update_bundle",
            action="store_true",
            default=True,
        ...
        flag_enablement_pilot_update_group.add_argument(
            ...
            dest="update_bundle",
            action="store_false",
            help="Run the flag enablement pilot and write local artifacts without updating the bundle",
        )
    production_default_api_user_visible_pilot_parser = subparsers.add_parser(
        "ml-shadow-scorer-production-scoped-shadow-production-default-api-user-visible-pilot-run",
        help="Run the bounded production-scoped production default/API/user-visible online shadow pilot",
    )
    production_default_api_user_visible_pilot_parser.add_argument(
        "--bundle",
        required=True,
        help="Path to production-scoped shadow bundle JSON",
    )
    production_default_api_user_visible_pilot_parser.add_argument(
        ...
        action="store_true",
        required=True,
        help="Required confirmation before the bounded production default/API/user-visible pilot",
    )
    production_default_api_user_visible_pilot_parser.add_argument(
        "--confirm-live-read-only-prod-source-reads",
        action="store_true",
    ...
    production_default_api_user_visible_pilot_parser.add_argument(
        "--pilot-run-id",
        default=None,
        help="Optional safe pilot run id; defaults to prod-output ranking_run_id plus UTC timestamp",
    )
    production_default_api_user_visible_pilot_parser.add_argument(
        "--repo-root",
        default=None,
    ...
    production_default_api_user_visible_pilot_update_group = (
        production_default_api_user_visible_pilot_parser.add_mutually_exclusive_group()
    )
    production_default_api_user_visible_pilot_update_group.add_argument(
        "--update-bundle",
        dest="update_bundle",
        action="store_true",
        default=True,
    ...
    ml_shadow_scorer_production_scoped_shadow_controlled_production_recommendation_pilot_review_parser = (
        subparsers.add_parser(
            "ml-shadow-scorer-production-scoped-shadow-controlled-production-recommendation-pilot-review",
            help="Review the recorded bounded controlled production recommendation pilot evidence",
        )
    )
    ml_shadow_scorer_production_scoped_shadow_controlled_production_recommendation_pilot_review_parser.add_argument(
        "--bundle",
        required=True,
        help="Path to production-scoped shadow bundle JSON",
    )
    ...
    ml_shadow_scorer_production_scoped_shadow_controlled_production_recommendation_pilot_review_parser.add_argument(
        "--review-notes",
        default=None,
        help="Optional free-text controlled production recommendation pilot review notes recorded verbatim",
    )
    ml_shadow_scorer_production_scoped_shadow_controlled_production_recommendation_pilot_review_parser.add_argument(
        "--repo-root",
        required=True,
        help="Repository root for resolving bundle references",
    )
    ...
    if args.command == "ml-shadow-scorer-online-shadow-policy":
        ...
        out_md = Path(args.markdown_output)
        try:
            payload = write_ml_shadow_scorer_online_shadow_policy(
        ...
        except MLShadowScorerOnlineShadowPolicyError as e:
            print(f"ml-shadow-scorer-online-shadow-policy: {e}", file=sys.stderr)
            raise SystemExit(e.code) from e
        print(out_json.resolve(), file=sys.stderr)
        print(out_md.resolve(), file=sys.stderr)
    ...
    if args.command == "ml-shadow-scorer-runtime-isolation-verification":
        from pipeline.ml_shadow_scorer_runtime_isolation_verification import (
            MLShadowScorerRuntimeIsolationVerificationError,
            write_ml_shadow_scorer_runtime_isolation_verification,
        )
        ...
        out_md = Path(args.markdown_output)
        try:
            payload = write_ml_shadow_scorer_runtime_isolation_verification(
                online_shadow_runtime_path=Path(args.online_shadow_runtime),
                generalization_audit_gates_path=Path(args.generalization_audit_gates),
                online_shadow_policy_path=Path(args.online_shadow_policy),
                output_path=out_json,
                markdown_output_path=out_md,
                verification_version=str(args.verification_version),
                repo_root=repo_root,
            )
        except MLShadowScorerRuntimeIsolationVerificationError as e:
            print(f"ml-shadow-scorer-runtime-isolation-verification: {e}", file=sys.stderr)
            raise SystemExit(e.code) from e
        print(out_json.resolve(), file=sys.stderr)
        print(out_md.resolve(), file=sys.stderr)
        print(payload["runtime_isolation_verification_passed"])
        print(payload["recommended_next_stage"])
        return

    if args.command == "ml-shadow-scorer-online-shadow-enablement-gates":
        from pipeline.ml_shadow_scorer_online_shadow_enablement_gates import (
            MLShadowScorerOnlineShadowEnablementGatesError,
            write_ml_shadow_scorer_online_shadow_enablement_gates,
        )
        ...
        out_md = Path(args.markdown_output)
        try:
            payload = write_ml_shadow_scorer_online_shadow_enablement_gates(
            ...
            print(f"ml-shadow-scorer-online-shadow-enablement-gates: {e}", file=sys.stderr)
            raise SystemExit(e.code) from e
        print(out_json.resolve(), file=sys.stderr)
        print(out_md.resolve(), file=sys.stderr)
    ...
    if args.command == "ml-shadow-scorer-online-shadow-execution-authorization-request":
        from pipeline.ml_shadow_scorer_online_shadow_execution_authorization_request import (
            ...
            write_ml_shadow_scorer_online_shadow_execution_authorization_request,
        )
        ...
        out_md = Path(args.markdown_output)
        try:
            payload = write_ml_shadow_scorer_online_shadow_execution_authorization_request(
                enablement_gates_run_path=Path(args.enablement_gates_run),
                output_path=out_json,
                markdown_output_path=out_md,
                request_version=str(args.request_version),
                repo_root=repo_root,
            )
        except MLShadowScorerOnlineShadowExecutionAuthorizationRequestError as e:
            print(f"ml-shadow-scorer-online-shadow-execution-authorization-request: {e}", file=sys.stderr)
            raise SystemExit(e.code) from e
        print(out_json.resolve(), file=sys.stderr)
        print(out_md.resolve(), file=sys.stderr)
    ...
    if args.command == "ml-shadow-scorer-online-shadow-phase1-no-write-pilot-review":
        ...
        try:
            payload = write_ml_shadow_scorer_online_shadow_phase1_no_write_pilot_review(
                phase1_no_write_pilot_run_path=Path(args.phase1_no_write_pilot_run),
                phase1_no_write_pilot_plan_path=Path(args.phase1_no_write_pilot_plan),
                authorization_grant_path=Path(args.authorization_grant),
                online_shadow_runtime_path=Path(args.online_shadow_runtime),
                output_path=out_json,
        ...
        except MLShadowScorerOnlineShadowPhase1NoWritePilotReviewError as e:
            print(f"ml-shadow-scorer-online-shadow-phase1-no-write-pilot-review: {e}", file=sys.stderr)
            raise SystemExit(e.code) from e
        print(out_json.resolve(), file=sys.stderr)
        print(out_md.resolve(), file=sys.stderr)
    ...
    if args.command == "ml-shadow-scorer-online-shadow-phase2-isolated-audit-write-mode-proof":
        ...
        out_md = Path(args.markdown_output)
        try:
            payload = write_ml_shadow_scorer_online_shadow_phase2_isolated_audit_write_mode_proof(
                ...
                proof_version=str(args.proof_version),
                repo_root=repo_root,
                cleanup_after_proof=bool(args.cleanup_after_proof),
            )
        except MLShadowScorerOnlineShadowPhase2IsolatedAuditWriteModeProofError as e:
            print(f"ml-shadow-scorer-online-shadow-phase2-isolated-audit-write-mode-proof: {e}", file=sys.stderr)
            raise SystemExit(e.code) from e
        print(out_json.resolve(), file=sys.stderr)
        print(out_md.resolve(), file=sys.stderr)
        print(payload["phase2_write_mode_proof_executed"])
        print(payload["phase2_write_mode_proof_passed"])
        print(payload["recommended_next_stage"])
        return

    if args.command == "ml-shadow-scorer-online-shadow-phase2-isolated-audit-write-authorization-request":
        from pipeline.ml_shadow_scorer_online_shadow_phase2_isolated_audit_write_authorization_request import (
            ...
            write_ml_shadow_scorer_online_shadow_phase2_isolated_audit_write_authorization_request,
        )
        ...
        out_md = Path(args.markdown_output)
        try:
            payload = write_ml_shadow_scorer_online_shadow_phase2_isolated_audit_write_authorization_request(
        ...
        except MLShadowScorerOnlineShadowPhase2IsolatedAuditWriteAuthorizationRequestError as e:
            print(
                f"ml-shadow-scorer-online-shadow-phase2-isolated-audit-write-authorization-request: {e}",
                file=sys.stderr,
            )
            raise SystemExit(e.code) from e
        print(out_json.resolve(), file=sys.stderr)
        print(out_md.resolve(), file=sys.stderr)
        print(payload["phase2_isolated_audit_write_authorization_requested"])
        print(payload["phase2_isolated_audit_write_authorization_granted"])
        print(payload["recommended_next_stage"])
        return

    if args.command == "ml-shadow-scorer-online-shadow-phase2-isolated-audit-write-authorization-grant":
        ...
        try:
            payload = write_ml_shadow_scorer_online_shadow_phase2_isolated_audit_write_authorization_grant(
                ...
                phase2_write_mode_proof_path=Path(args.phase2_write_mode_proof),
                phase2_write_mode_plan_path=Path(args.phase2_write_mode_plan),
                execution_authorization_grant_path=Path(args.execution_authorization_grant),
                output_path=out_json,
                markdown_output_path=out_md,
                grant_version=str(args.grant_version),
                repo_root=repo_root,
            )
        except MLShadowScorerOnlineShadowPhase2IsolatedAuditWriteAuthorizationGrantError as e:
            print(
                f"ml-shadow-scorer-online-shadow-phase2-isolated-audit-write-authorization-grant: {e}",
                file=sys.stderr,
            )
            raise SystemExit(e.code) from e
        print(out_json.resolve(), file=sys.stderr)
    ...
    if args.command == "ml-shadow-scorer-production-scoped-shadow-bundle-grant-pilot":
        from pipeline.ml_shadow_scorer_production_scoped_shadow_bundle import (
            MLShadowScorerProductionScopedShadowBundleError,
        ...
        repo_root = Path(args.repo_root) if args.repo_root else None
        try:
            payload = grant_pilot_ml_shadow_scorer_production_scoped_shadow_bundle(
                bundle_path=Path(args.bundle),
                owner=str(args.owner),
                second_reviewer=args.second_reviewer,
                owner_documents_equivalent_review=args.owner_documents_equivalent_review,
            ...
            print(f"ml-shadow-scorer-production-scoped-shadow-bundle-grant-pilot: {e}", file=sys.stderr)
            raise SystemExit(e.code) from e
        print(payload["authorization"]["grant_decision"]["decision"])
        print(payload["authorization"]["prod_scoped_shadow_pilot_authorized"])
        print(payload["recommended_next_stage"])
        return

    if args.command == "ml-shadow-scorer-production-scoped-shadow-pilot-harness-run":
        ...
        repo_root = Path(args.repo_root) if args.repo_root else None
        try:
            result = run_ml_shadow_scorer_production_scoped_shadow_pilot_harness(
                bundle_path=Path(args.bundle),
                pilot_run_id=args.pilot_run_id,
                fixture_input_path=Path(args.fixture_input) if args.fixture_input else None,
                repo_root=repo_root,
        ...
        except MLShadowScorerProductionScopedShadowPilotHarnessError as e:
            print(f"ml-shadow-scorer-production-scoped-shadow-pilot-harness-run: {e}", file=sys.stderr)
            raise SystemExit(e.code) from e
        print(result["pilot_run_id"])
        print(result["pilot_harness_passed"])
        print(result["recommended_next_stage"])
        return
    ...
    if args.command == "ml-shadow-scorer-production-scoped-shadow-live-execution-pilot-review":
        ...
        try:
        ...
        except MLShadowScorerProductionScopedShadowLiveExecutionPilotReviewError as e:
            print(
                "ml-shadow-scorer-production-scoped-shadow-live-execution-pilot-review: "
                f"{e}",
                file=sys.stderr,
            ...
            raise SystemExit(e.code) from e
        print(result["review"]["live_execution_pilot_review_decision"]["decision"])
        print(result["live_execution_pilot_accepted"])
        print(result["recommended_next_stage"])
        return
    ...
    if args.command == "ml-shadow-scorer-production-scoped-shadow-bundle-request-flag-enablement":
        ...
        repo_root = Path(args.repo_root) if args.repo_root else None
        try:
            payload = request_flag_enablement_ml_shadow_scorer_production_scoped_shadow_bundle(
                bundle_path=Path(args.bundle),
                requester=str(args.requester),
                request_notes=args.request_notes,
                repo_root=repo_root,
            ...
            raise SystemExit(e.code) from e
        print(payload["authorization"]["flag_enablement_request_decision"]["decision"])
        print(payload["authorization"]["prod_scoped_shadow_flag_enablement_authorization_requested"])
        print(payload["recommended_next_stage"])
        return

    if args.command == "ml-shadow-scorer-production-scoped-shadow-bundle-request-production-default-api-user-visible":
        from pipeline.ml_shadow_scorer_production_scoped_shadow_bundle import (
            MLShadowScorerProductionScopedShadowBundleError,
        ...
        repo_root = Path(args.repo_root) if args.repo_root else None
        try:
            payload = request_production_default_api_user_visible_ml_shadow_scorer_production_scoped_shadow_bundle(
                bundle_path=Path(args.bundle),
                requester=str(args.requester),
                request_notes=args.request_notes,
                repo_root=repo_root,
            ...
            raise SystemExit(e.code) from e
        print(payload["authorization"]["production_default_api_user_visible_request_decision"]["decision"])
        print(
    ...
    if args.command == "ml-shadow-scorer-production-scoped-shadow-bundle-request-controlled-production-recommendation":
        from pipeline.ml_shadow_scorer_production_scoped_shadow_bundle import (
            MLShadowScorerProductionScopedShadowBundleError,
        ...
        repo_root = Path(args.repo_root) if args.repo_root else None
        try:
            payload = request_controlled_production_recommendation_ml_shadow_scorer_production_scoped_shadow_bundle(
                bundle_path=Path(args.bundle),
                requester=str(args.requester),
                request_notes=args.request_notes,
                repo_root=repo_root,
            ...
            raise SystemExit(e.code) from e
        print(payload["authorization"]["controlled_production_recommendation_request_decision"]["decision"])
        print(
            payload["authorization"][
                "prod_scoped_shadow_controlled_production_recommendation_authorization_requested"
            ]
        )
        print(payload["recommended_next_stage"])
        return
    ...
    if (
        ...
        try:
            ...
            raise SystemExit(e.code) from e
        print(payload["authorization"]["limited_production_recommendation_rollout_request_decision"]["decision"])
        print(
            payload["authorization"][
    ...
    if (
        ...
        repo_root = Path(args.repo_root) if args.repo_root else None
        try:
            payload = grant_production_default_api_user_visible_ml_shadow_scorer_production_scoped_shadow_bundle(
                bundle_path=Path(args.bundle),
                owner=str(args.owner),
                second_reviewer=args.second_reviewer,
                owner_documents_equivalent_review=args.owner_documents_equivalent_review,
            ...
            raise SystemExit(e.code) from e
        print(payload["authorization"]["production_default_api_user_visible_grant_decision"]["decision"])
        print(
            payload["authorization"][
    ...
    if args.command == "ml-shadow-scorer-production-scoped-shadow-bundle-grant-flag-enablement":
        from pipeline.ml_shadow_scorer_production_scoped_shadow_bundle import (
            MLShadowScorerProductionScopedShadowBundleError,
        ...
        repo_root = Path(args.repo_root) if args.repo_root else None
        try:
            payload = grant_flag_enablement_ml_shadow_scorer_production_scoped_shadow_bundle(
                bundle_path=Path(args.bundle),
                owner=str(args.owner),
                second_reviewer=args.second_reviewer,
                owner_documents_equivalent_review=args.owner_documents_equivalent_review,
            ...
            raise SystemExit(e.code) from e
        print(payload["authorization"]["flag_enablement_grant_decision"]["decision"])
        print(payload["authorization"]["prod_scoped_shadow_flag_enablement_authorized"])
        print(payload["recommended_next_stage"])
        return
    ...
    if args.command == "ml-shadow-scorer-production-scoped-shadow-bundle-request-live-read-only":
        ...
        repo_root = Path(args.repo_root) if args.repo_root else None
        try:
            payload = request_live_read_only_ml_shadow_scorer_production_scoped_shadow_bundle(
                bundle_path=Path(args.bundle),
                requester=str(args.requester),
                request_notes=args.request_notes,
                repo_root=repo_root,
            ...
            raise SystemExit(e.code) from e
        print(payload["authorization"]["request_decision"]["decision"])
        print(payload["authorization"]["prod_scoped_shadow_live_read_only_authorization_requested"])
        print(payload["recommended_next_stage"])
        return

    if args.command == "ml-shadow-scorer-production-scoped-shadow-bundle-request-live-execution":
        from pipeline.ml_shadow_scorer_production_scoped_shadow_bundle import (
            MLShadowScorerProductionScopedShadowBundleError,
        ...
        repo_root = Path(args.repo_root) if args.repo_root else None
        try:
            payload = request_live_execution_ml_shadow_scorer_production_scoped_shadow_bundle(
                bundle_path=Path(args.bundle),
                requester=str(args.requester),
                request_notes=args.request_notes,
                repo_root=repo_root,
            ...
            raise SystemExit(e.code) from e
        print(payload["authorization"]["live_execution_request_decision"]["decision"])
        print(payload["authorization"]["prod_scoped_shadow_live_execution_authorization_requested"])
        print(payload["recommended_next_stage"])
        return

    if args.command == "ml-shadow-scorer-production-scoped-shadow-bundle-grant-live-execution":
        from pipeline.ml_shadow_scorer_production_scoped_shadow_bundle import (
            MLShadowScorerProductionScopedShadowBundleError,
        ...
        repo_root = Path(args.repo_root) if args.repo_root else None
        try:
            payload = grant_live_execution_ml_shadow_scorer_production_scoped_shadow_bundle(
                bundle_path=Path(args.bundle),
                owner=str(args.owner),
                second_reviewer=args.second_reviewer,
                owner_documents_equivalent_review=args.owner_documents_equivalent_review,
            ...
            raise SystemExit(e.code) from e
        print(payload["authorization"]["live_execution_grant_decision"]["decision"])
        print(payload["authorization"]["prod_scoped_shadow_live_execution_authorized"])
        print(payload["recommended_next_stage"])
        return
    ...
    if args.command in {
        ...
        repo_root = Path(args.repo_root) if args.repo_root else None
        try:
            result = run_ml_shadow_scorer_production_scoped_shadow_live_execution_pilot(
                bundle_path=Path(args.bundle),
                database_url=args.database_url,
                pilot_run_id=args.pilot_run_id,
                repo_root=repo_root,
                update_bundle=bool(args.update_bundle),
                confirm_live_execution_pilot=bool(args.confirm_live_execution_pilot),
                confirm_live_read_only_prod_source_reads=bool(args.confirm_live_read_only_prod_source_reads),
            )
        except MLShadowScorerProductionScopedShadowLiveExecutionPilotError as e:
            print(f"{args.command}: {e}", file=sys.stderr)
            raise SystemExit(e.code) from e
        print(result["pilot_run_id"])
        print(result["prod_scoped_shadow_live_execution_pilot_passed"])
        print(result["recommended_next_stage"])
        return
    ...
    if args.command in {
        ...
        repo_root = Path(args.repo_root) if args.repo_root else None
        try:
            result = run_ml_shadow_scorer_production_scoped_shadow_flag_enablement_pilot(
                bundle_path=Path(args.bundle),
                database_url=args.database_url,
                pilot_run_id=args.pilot_run_id,
                repo_root=repo_root,
                update_bundle=bool(args.update_bundle),
                confirm_flag_enablement_pilot=bool(args.confirm_flag_enablement_pilot),
                confirm_live_read_only_prod_source_reads=bool(args.confirm_live_read_only_prod_source_reads),
            )
        except MLShadowScorerProductionScopedShadowFlagEnablementPilotError as e:
            print(f"{args.command}: {e}", file=sys.stderr)
            raise SystemExit(e.code) from e
        print(result["pilot_run_id"])
        print(result["prod_scoped_shadow_flag_enablement_pilot_passed"])
        print(result["recommended_next_stage"])
        return

    if args.command == "ml-shadow-scorer-production-scoped-shadow-production-default-api-user-visible-pilot-run":
        ...
        repo_root = Path(args.repo_root) if args.repo_root else None
        try:
            result = run_ml_shadow_scorer_production_scoped_shadow_production_default_api_user_visible_pilot(
                bundle_path=Path(args.bundle),
                database_url=args.database_url,
                pilot_run_id=args.pilot_run_id,
                repo_root=repo_root,
                update_bundle=bool(args.update_bundle),
                confirm_production_default_api_user_visible_pilot=bool(
                    args.confirm_production_default_api_user_visible_pilot
                ),
                confirm_live_read_only_prod_source_reads=bool(args.confirm_live_read_only_prod_source_reads),
            )
        except MLShadowScorerProductionScopedShadowProductionDefaultAPIUserVisiblePilotError as e:
            print(f"{args.command}: {e}", file=sys.stderr)
            raise SystemExit(e.code) from e
        print(result["pilot_run_id"])
        print(result["prod_scoped_shadow_production_default_api_user_visible_pilot_passed"])
        print(result["recommended_next_stage"])
        return
    ...
    if (
        ...
        try:
            result = review_ml_shadow_scorer_production_scoped_shadow_controlled_production_recommendation_pilot(
                bundle_path=Path(args.bundle),
                reviewer=str(args.reviewer),
                review_notes=args.review_notes,
                repo_root=Path(args.repo_root),
            )
        except MLShadowScorerProductionScopedShadowControlledProductionRecommendationPilotReviewError as e:
            print(
                "ml-shadow-scorer-production-scoped-shadow-controlled-production-recommendation-pilot-review: "
                f"{e}",
                file=sys.stderr,
            ...
            raise SystemExit(e.code) from e
        print(result["review"]["controlled_production_recommendation_pilot_review_decision"]["decision"])
        print(result["controlled_production_recommendation_pilot_accepted"])
        print(result["recommended_next_stage"])
        return
    ...
    if args.command == "ml-shadow-scorer-production-scoped-shadow-bundle-verify":
        ...
        expect_live_execution_request_filed = None
        expect_live_execution_grant_filed = None
        expect_live_execution_pilot_run_filed = None
        expect_live_execution_pilot_review_filed = None
        ...
        elif args.expect_pilot_grant_filed:
        ...
        elif args.expect_live_execution_request_filed:
            expect_live_execution_request_filed = True
        elif args.expect_live_execution_grant_filed:
            expect_live_execution_grant_filed = True
        elif args.expect_live_execution_pilot_run_filed:
            expect_live_execution_pilot_run_filed = True
        elif args.expect_live_execution_pilot_review_filed:
            expect_live_execution_pilot_review_filed = True
        elif args.expect_flag_enablement_request_filed:
            expect_flag_enablement_request_filed = True
        elif args.expect_flag_enablement_grant_filed:
        ...
        elif args.expect_production_default_api_user_visible_request_filed:
            expect_production_default_api_user_visible_request_filed = True
        elif args.expect_production_default_api_user_visible_grant_filed:
        ...
        elif args.expect_controlled_production_recommendation_pilot_review_filed:
