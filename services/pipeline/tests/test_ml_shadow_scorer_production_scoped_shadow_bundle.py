...
def test_committed_bundle_fixture_matches_post_live_read_only_pilot_run_if_present() -> None:
    ...
    assert result["bundle_revision"] == 11
    assert result["recommended_next_stage"] == "review_production_scoped_online_shadow_live_read_only_pilot_v1"
