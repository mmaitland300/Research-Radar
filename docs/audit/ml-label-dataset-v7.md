# Manual label dataset (ml-label-dataset-v7)
...
Machine-readable export: regenerate via `python -m pipeline.cli ml-label-dataset-v7-external-near-miss-ingest --base-dataset docs/audit/ml-label-dataset-v6.json --blank-worksheet docs/audit/manual-review/ml_external_near_miss_review_v1.csv --labeled-worksheet docs/audit/manual-review/ml_external_near_miss_review_v1_labeled_2026-05-13.csv --context-sidecar docs/audit/manual-review/ml_external_near_miss_review_v1_context.json --conflict-policy docs/audit/ml-label-conflict-policy.md --output <path>.json`.
