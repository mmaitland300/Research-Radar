# Manual label dataset (ml-label-dataset-v5)
...
Machine-readable export: regenerate via `python -m pipeline.cli ml-label-dataset-v5-reviewer-blind-ingest --base-dataset docs/audit/ml-label-dataset-v4.json --blank-worksheet docs/audit/manual-review/ml_blind_snapshot_review_v2.csv --labeled-worksheet docs/audit/manual-review/ml_blind_snapshot_review_v2_labeled_2026-05-13.csv --context-sidecar docs/audit/manual-review/ml_blind_snapshot_review_v2_context.json --output <path>.json`.
