# Manual label dataset (ml-label-dataset-v6)
...
Machine-readable export: regenerate via `python -m pipeline.cli ml-label-dataset-v6-hard-negative-ingest --base-dataset docs/audit/ml-label-dataset-v5.json --blank-worksheet docs/audit/manual-review/ml_hard_negative_review_v1.csv --labeled-worksheet docs/audit/manual-review/ml_hard_negative_review_v1_labeled_2026-05-13.csv --context-sidecar docs/audit/manual-review/ml_hard_negative_review_v1_context.json --output <path>.json`.
