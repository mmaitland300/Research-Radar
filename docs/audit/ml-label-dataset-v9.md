# Manual label dataset (ml-label-dataset-v9)
...
Machine-readable export: regenerate via `python -m pipeline.cli ml-label-dataset-v9-fresh-hybrid-ingest --base-dataset docs/audit/ml-label-dataset-v8.json --blank-worksheet docs/audit/manual-review/fresh_hybrid_eval_v1.csv --labeled-worksheet docs/audit/manual-review/fresh_hybrid_eval_v1_labeled_2026-05-19.csv --context-sidecar docs/audit/manual-review/fresh_hybrid_eval_v1_context.json --conflict-policy docs/audit/ml-label-conflict-policy.md --output <path>.json`.
