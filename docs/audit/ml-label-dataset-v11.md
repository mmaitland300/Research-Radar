# Manual label dataset (ml-label-dataset-v11)
...
Machine-readable export: regenerate via `python -m pipeline.cli ml-label-dataset-v11-shadow-generalization-ingest --base-dataset docs/audit/ml-label-dataset-v10.json --blank-worksheet docs/audit/manual-review/shadow_generalization_second_surface_v1.csv --labeled-worksheet docs/audit/manual-review/shadow_generalization_second_surface_v1_labeled_2026-05-23.csv --context-sidecar docs/audit/manual-review/shadow_generalization_second_surface_v1_context.json --generalization-second-surface docs/audit/ml-shadow-scorer-v1-generalization-second-surface-v1.json --conflict-policy docs/audit/ml-label-conflict-policy.md --output <path>.json`.
