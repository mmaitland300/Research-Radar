...
- **label_dataset_path:** `docs/audit/ml-label-dataset-v8.json`
...
- **generated_at:** `2026-05-16T04:24:30Z`

## Join summary

- **Label rows (audit_only, run match, after row_id dedupe):** 257
- **Duplicate row_id rows skipped:** 0
- **Joined to paper_scores:** 130
- **Missing from ranking (no score row for family/work):** 127
