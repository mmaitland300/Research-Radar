# Manual label dataset (ml-label-dataset-v8)
...
Machine-readable export: regenerate via `python -m pipeline.cli ml-label-dataset-v8-transfer-gap-ingest --base-dataset docs/audit/ml-label-dataset-v7.json --blank-worksheet docs/audit/manual-review/ml_transfer_gap_review_v1.csv --labeled-worksheet docs/audit/manual-review/ml_transfer_gap_review_v1_labeled_2026-05-15.csv --context-sidecar docs/audit/manual-review/ml_transfer_gap_review_v1_context.json --conflict-policy docs/audit/ml-label-conflict-policy.md --output <path>.json`.
