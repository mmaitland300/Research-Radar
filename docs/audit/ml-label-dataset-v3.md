# Manual label dataset (ml-label-dataset-v3)
...
Machine-readable export: regenerate via `python -m pipeline.cli ml-label-dataset --dataset-version ml-label-dataset-v3 --output <path>.json`.
