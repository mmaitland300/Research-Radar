...
- Verbatim text_for_embedding was embedded; cross-pool comparison to DB title+abstract format may require a documented transform in a later experiment, not silent relabeling here.
